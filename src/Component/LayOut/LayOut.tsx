  ...
  return (
    <div className="w-full flex justify-center ">
      <div className="h-full  w-full max-w-[1400px]  ">
        <nav className="w-full max-w-[1400px] bg-slate-900 h-16 z-50 fixed flex  items-center justify-end text-yellow-400">
          <button
        ...
        <section>
          <div className="bg-slate-900 h-[30vh] flex flex-wrap   items-center mt-10">
            <div className="flex md:w-1/2 px-10 md:px-0 justify-center items-center">
            ...
            <div className="flex md:w-1/2 px-10 md:px-0 justify-center">
